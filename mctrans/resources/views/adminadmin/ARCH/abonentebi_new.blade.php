        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card m-b-20">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('abonentebi_insert') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="form-label">მონიშნეთ ტარიფი</label>
                                    </div>
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="abonentebi_tarifi" required>
                                            <option selected disabled value="">აირჩიეთ ტარიფი</option>


                                            @foreach ($tarifi as $tarifi_item)

                                            <option value="{{$tarifi_item->tarifi_id}}">{{$tarifi_item->tarifi_dasaxeleba}} {{$tarifi_item->tarifi_fasi}}</option>
